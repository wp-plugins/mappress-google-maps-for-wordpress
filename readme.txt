...
1.7.10 Beta
=
* Fix for firefox causing scrollbar in infowindow
* Added option to automatically center/left/right align map.  Can also specify in shortcode: [mappress alignment="left|right|center|default"]
* Fixed warning message on activation during table create when plugin previously installed
* Fixed language parameter - maps were only rendering in English
