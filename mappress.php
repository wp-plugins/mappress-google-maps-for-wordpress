...
class Mappress {
	...
	*/
	...
	function admin_init() {
		...
		add_settings_field('list', __('Location list', 'mappress'), array(&$this, 'set_poi_list'), 'mappress', 'mappress_pro_settings');
		add_settings_field('link', __('MapPress link', 'mappress'), array(&$this, 'set_control'), 'mappress', 'mappress_pro_settings');
		add_settings_field('meta_key', __('Custom fields', 'mappress'), array(&$this, 'set_meta_key'), 'mappress', 'mappress_pro_settings');
	}
	...
	function set_meta_key() {
		...
		printf(__("This function requires $pro_link", 'mappress'), $pro_link);
	}
