...
class mappress {
	...
	function mappress()  {
		...
		$upgrader = new Monster_Upgrade(plugin_basename(__FILE__), 'mappress-google-maps-for-wordpress', $this->version, 'http://wphostreviews.com/mappress/mappress-beta');
	...
	*/
	function hook_head() {
		...
		if (empty($this->icons)) {
			$this->icons = mpicon::read("", 'icons.txt');
