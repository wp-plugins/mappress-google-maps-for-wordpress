...
// Unfortunately, the 2.9 function calls the wrong method in the underlying Services_JSON class.
// It calls 'encode', but it should call '_encode' or 'encodeUnsafe'
//
// To avoid this, I'm temporarily using my own function 'mapp_json_encode' which
// calls the correct class method.  If PHP version > 5.2 and native function exists it won't be used.
//
// Once WP 2.9.1 is released this function can be REMOVED and calls to mapp_json_encode should be replaced with json_encode
//
